...
rfrprop=\usevalue{lfrprop}
  ...
  \begin{figure}
    ...
    \centerline{\includegraphics[width=1.0\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/Data_summary1.eps}}
  \end{figure}
  }{
  \begin{figure}
    %\centering
    %\selectcolormodel{rgb}
    \centerline{\includegraphics[width=0.5\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/Data_summary2.eps}}
  \end{figure}
  }
  \begin{itemize}
...
\begin{slide}[toc=,bm=]{ Outliers Analysis}
  ...
  \begin{figure}
    \centering
    %\selectcolormodel{rgb}
    \centerline{\includegraphics[scale=0.4,width=0.8\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/countboxplot.eps}}
  \end{figure}
  \end{slide}
  %%
  %%==========================================================================================
  ...
  \begin{slide}[toc=,bm=]{ Data Visualization between count vs. month and season }
    ...
    \begin{figure}
      \centering
      %\selectcolormodel{rgb}
      \centerline{\includegraphics[scale=0.4,width=0.5\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/data_vis1.eps}}
    ...
    \begin{slide}[toc=,bm=]{ Data Visualization between count vs. weekdays and usertype }
      ...
      \begin{figure}
        \centering
        %\selectcolormodel{rgb}
        \centerline{\includegraphics[scale=0.4,width=0.5\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/data_vis2.eps}}
      ...
      \begin{slide}[toc=,bm=]{ Data Visualization of count and [temp, windspeed, humidity]}
        ...
        \begin{figure}
          \centering
          %\selectcolormodel{rgb}
          \centerline{\includegraphics[scale=0.4,width=1.0\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/scatterplot.eps}}
  ...
  \begin{slide}[toc=,bm=]{ Correlation Matrix }
    ...
    \begin{figure}
      \centering
      %\selectcolormodel{rgb}
      \centerline{\includegraphics[scale=0.4,width=0.8\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/heatmap.eps}}
...
\begin{slide}[toc=,bm=]{ Skewness in Data Distribution}
  ...
  \begin{figure}
    \centering
    %\selectcolormodel{rgb}
    \centerline{\includegraphics[scale=0.4,width=1.0\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/skewness_before.eps}}
  ...
  \begin{slide}[toc=,bm=]{ Solution to Skewness in Data Distribution}
    ...
    \begin{figure}
      \centering
      %\selectcolormodel{rgb}
      \centerline{\includegraphics[scale=0.4,width=1.0\textwidth,height=0.4\textwidth]{/Users/pratikshyaparajuli/Desktop/bike_sharing_img/skewness_after.eps}}
